...
function fCard() {
  document.querySelector(".f_card").innerHTML = ` <div class="weather-cards   ">
                            ...
                            <div class="info  h-100">
                                ...
                                <div class="degree ">
                                    ...
                                    <div class="num_degree d-inline-block ">${Number(
                                      allweatherdata.current.temp_c
                                    )}<sup>o</sup>C</div>
                                    <div class="icon d-inline-block">
                                    <img src="https:${
                                      allweatherdata.current.condition.icon
                                    }"
                                            alt="" class="degree_img">
                                    </div>
...
function SCard() {
  document.querySelector(
    ".s-card"
  ).innerHTML = `  <div class="weather-cards text-center ">
                            <div class="day pb-2 pt-2 day_after ">${daysCard}</div>
                            <div class=" info_dayafter h-100">
                                <div class="icon_dayafter pt-5 pb-3 ">
                                    <img src="https:${
                                      allweatherdata.forecast.forecastday[1].day
                                        .condition.icon
                                    }" alt="sun">
                                </div>
                                <div class="degree_dayafter ">
                                    <div class="maxtemp_C">${Number(
                                      allweatherdata.forecast.forecastday[1].day
                                        .maxtemp_c
                                    )}<sup>o</sup>C</div>
                                    <small class="mintemp_C">${Number(
                                      allweatherdata.forecast.forecastday[1].day
                                        .mintemp_c
                                    )}<sup>o</sup>C</small>

                                </div>
                                <div class="state_dayafter ">${
                                  allweatherdata.forecast.forecastday[1].day
                                    .condition.text
                                }</div>
  ...
  document.querySelector(
    ".t-card"
                            ...
                            <div class="info h-100">
                                <div class="icon_dayafter pt-5 pb-3 ">
                                    <img src="https:${
                                      allweatherdata.forecast.forecastday[2].day
                                        .condition.icon
                                    }" alt="sun">
                                </div>
                                <div class="degree_dayafter ">
